...
public class EmployeeController {
	...
	//@RequestBody gets all the values from the request and adds them to the employee object.	
	@PostMapping("/add")
	public ResponseEntity<Employee> addEmployee(@RequestBody Employee employee){
		Employee newEmployee = employeeService.addEmployee(employee);
		return new ResponseEntity<>(newEmployee, HttpStatus.CREATED); //CREATED is used because we just created a new piece of information
	}
